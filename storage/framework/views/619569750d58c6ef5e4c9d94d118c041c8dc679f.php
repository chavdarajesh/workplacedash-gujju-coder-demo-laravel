<div class="gc-form-title">
    <h5><?php echo e(__('New Vaccinations')); ?></h5>
</div>
...
<form id="vaccinationsstore" action="<?php echo e(route('vaccinationsstore')); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input required type="datetime-local" value="<?php echo e(old('date_administered')); ?>" name="date_administered"
    ...
    <button type="button" class="btn btn-primary addsecondvaccinations"><?php echo e(__('+ Add Vaccination')); ?></button>
    ...
    <div class="secondvaccinations row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label for="exampleInputEmail1"><?php echo e(__('Date administered')); ?><span class="required">*</span></label>
                <input type="datetime-local" value="<?php echo e(old('second_date_administered')); ?>"
        ...
        <div class="col-md-12">
            <div class="form-group gcsptreeviewwapepe classvaccine_type">
                <label for="exampleInputEmail1"><?php echo e(__('Vaccine type')); ?><span class="required">*</span></label>
                <?php echo GetVaccinetypeDropDown(false, true); ?>
...
<?php /**PATH /opt/lampp/htdocs/Laravel/interview_rajkot/workplacedash-laravel-8/workplacedash/resources/views/vaccinations/create.blade.php ENDPATH**/ ?>