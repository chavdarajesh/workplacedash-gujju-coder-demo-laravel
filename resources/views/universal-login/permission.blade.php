...
<div class="gcsppermissionwapper">
    <div class="gcspuserheding"><h3><i class="fa fa-user pr-2"></i>{{$Users->name}}</h3></div>    
<form action="{{route('universalpostpermission')}}" method="post">
    @csrf
    <input type="hidden" name="upd_user_id" value="{{$Users->id}}">
    <div class="permissionLicensestable mt-5">
    ...
    <div class="permissionLicensestable mt-5 mb-5 aceessrole{{$Users->is_admin}}">
    ...
    <button type="submit" class="btn btn-primary mb-4">{{__('Save')}}</button> 
</form>
</div>
</div>
@endsection
