...
class UsersControllers extends Controller
{
    ...
    public function index()
    {
        ...
        $page_title='Users';            
        return view('users.users',compact('Users','page_title','cuser'));
    }
    ...
    public function deleted()
    {
        ...
        $page_title='Users';            
        return view('users.usersdeleted',compact('Users','page_title','cuser'));
    }
    ...
    {        
        ...
        return view('users.create', compact('Roles','page_title','sites','cuser'));
    }
    ...
    {    
        ...
        return Redirect::route('users')->with('success',__('User successfully added.'));
    }
    ...
    public function edit(Request $request)
    {
        ...
        if(empty($Users)){
            return Redirect::route('users')->with('error',__('User not found.'));   
        } 
        $Roles=Roles::orderby('id','desc')->get();
        ...
        return view('users.edit', compact('Roles','page_title','Users','sites','user_site','cuser'));
    }
    ...
    {    
        ...
        return Redirect::route('users')->with('success',__('User successfully updated.'));
    }
    ...
    public function restore($id)
    {
        ...
        return Redirect::route('users')->with('success',__('User successfully restored.'));
    }
    ...
    public function GetPermission($id)
    {
        ...
        return view('users.permission', compact('Roles','page_title','Users','permissions','cuser'));    
    }
    ...
    {    
        ...
        return Redirect::route('users')->with('success',__('Email verification notification sent successfully.'));
    }
