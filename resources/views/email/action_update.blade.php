...
<tr>
                ...
                <td style="padding:15px 10px 15px 10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td>
                        <p style="font-size:16px; font-family: 'Roboto', sans-serif;">{{__('The following action has been updated and notified to the Process Owner / Area-In-Charge in')}} {{$sitesname}}.</p>                        
                      </td>
                    </tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #ccc; border-right:none;">
                          <tr style="vertical-align: top;">                                                        
                            ...
                            <tr style="vertical-align: top;">                              
                              ...
                              <td style="padding:10px; border-right:1px solid #ccc; border-top:1px solid #ccc; font-size:16px; font-family: 'Roboto', sans-serif; max-width: 200px;">{{ $action['description'] }}</td>
