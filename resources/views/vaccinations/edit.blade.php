...
<form id="vaccinationupdate" action="{{ route('vaccinationupdate') }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="datetime-local"
                    value="{{ date('Y-m-d', strtotime($Vaccination->date_administered)) }}T{{ date('H:i:s', strtotime($Vaccination->date_administered)) }}"
        ...
        <div class="col-md-12">
            <div class="form-group gcsptreeviewwapepe classvaccine_type">
                ...
                {!! GetVaccinetypeDropDown(false, false, $Vaccination->vaccine_type, $Vaccination->other_vaccine_type) !!}
            </div>
    ...
    <button type="button" <?php echo $Vaccination->second_vaccinated == 1 ? 'style="display:none"' : 'style="display:inline"'; ?>
        class="btn btn-primary addsecondvaccinations">{{ __('+ Add Vaccination') }}</button>
    ...
    <div class="secondvaccinations row" <?php echo $Vaccination->second_vaccinated == 1 ? 'style="display:block"' : 'style="display:none"'; ?>>
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label for="exampleInputEmail1">{{ __('Date administered') }}<span class="required">*</span></label>
                <input type="datetime-local"
                    value="{{ $Vaccination->second_date_administered ? date('Y-m-d', strtotime($Vaccination->second_date_administered)) . 'T' . date('H:i:s', strtotime($Vaccination->second_date_administered)) : '' }}"
