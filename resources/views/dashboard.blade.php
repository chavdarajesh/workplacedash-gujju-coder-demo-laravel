	   	    ...
	   	    <div class="gc-testdate">
				  ...
				  <div class="row">
				    ...
				    <div class="col-md-8 mb-4">
				      <div class="md-form">
				          <input type="text" class="gcspdaterangepicker dashboardchange" id="" name="filterdate" placeholder="{{date('d M, Y')}}">
...
<div class="row row-eq-height gc-chartbox">
  ...
  <div class="col-md-4 mb-4">
    <div class="card dashboard-card">
      <div class="card-body">
        <h6 class="card-title gc-cardtitle">{{__('Near Miss by Rating')}}</h6>
  ...
  <!-- <div class="col-md-4 mb-4">
    <div class="card dashboard-card">
      <div class="card-body">
        <h6 class="card-title gc-cardtitle">{{__('Incidents by Categories')}}</h6>
        <div class="columnchart">
  ...
  <div class="col-md-4 mb-4">
    <div class="card dashboard-card">
      <div class="card-body">
        <h6 class="card-title gc-cardtitle">{{__('Incidents by Rating')}}</h6>
        <div class="columnchart">
  ...
  <div class="col-md-4 mb-4">
    <div class="card dashboard-card">
      <div class="card-body">
        <h6 class="card-title gc-cardtitle">{{__('Actions')}}</h6>
        <div class="columnchart">
...
@if($cuser->hasRole('Super Admin') || $cuser->can('Observations') || $cuser->can('Incident') || $cuser->can('Audit'))  
